...
const OrganizationStructure = React.lazy(() =>
  import("./pages/OrganizationStructure")
);
...
const NewsInformation = React.lazy(() =>
  import("./pages/News/NewsInformation")
);
const DetailNews = React.lazy(() => import("./pages/News/DetailNews"));
const StoreForm = React.lazy(() => import("./pages/StoreForm"));
...
const AdminListDataWarga = React.lazy(() =>
  import("./pages/Admin/ListDataWarga")
);
